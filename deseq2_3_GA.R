...
setwd("C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/gastrocnemius/renamed_files")
directory <- "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/gastrocnemius/renamed_files"

##---Set up DESeq2 data, based on names of HTSeq counts in working directory---
sampleFiles <- dir(pattern = 'sorted')
print(sampleFiles)
sampleIdentifiers <- c("C1", "C2", "C3", "M1", "M2")
...
#print(OGPCAN_matrix)
OGPCAN_matrix$Condition <- c("Control", "Control", "Control", "MCK", "MCK")
#print(OGPCAN_matrix)
