...
#print(OGPCAN_matrix)
OGPCAN_matrix$Condition <- c("S","S","S","S","Tibialis", "Tibialis")
#print(OGPCAN_matrix)
...
res.TA_SOL_M <- results(ddsHTSeqFiltered, contrast = c("condition", "S", "T"))
...
write.table(res.TA_SOL_M_filtered2, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.TA_SOL_M_filtered_padj_20180831.txt", 
            sep ="\t")
write.table(res.TA_SOL_M_filtered3, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.TA_SOL_M_filtered_padjfoldchange_20180831.txt", 
            sep ="\t")
write.table(res.TA_SOL_M, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.TA_SOL_M_20180820.txt", 
            sep = "\t")
