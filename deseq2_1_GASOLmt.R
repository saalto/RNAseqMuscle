...
setwd("C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/mutant/GAvsSOL/")
directory <- "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/mutant/GAvsSOL/"

#-----Set up DESeq2 data, based on names of HTSeq counts in working directory-----
sampleFiles <- dir(pattern = 'sorted')
#print(sampleFiles)

sampleIdentifier <- c("G1", "G2", "S1", "S2", "S3", "S4", "S5")
#sample group set up
...
res.SOL_GA_M_filtered2$absFC <- abs(res.SOL_GA_M_filtered2$log2FoldChange)
#head(res.SOL_GA_M_filtered2)
#dim(res.SOL_GA_M_filtered2)

res.SOL_GA_M_filtered3 <- subset(res.SOL_GA_M_filtered2, absFC > 1)
#head(res.SOL_GA_M_filtered3)
#dim(res.SOL_GA_M_filtered3)

#---Print out the filtered data as a text file---
write.table(res.SOL_GA_M_filtered2, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.SOL_GA_M_filtered_padj_20180918.txt", 
            sep ="\t")
write.table(res.SOL_GA_M_filtered3, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.SOL_GA_M_filtered_padjfoldchange_20180918.txt", 
            sep ="\t")
write.table(res.SOL_GA_M, 
            "C:/Users/sarah/OneDrive/Documents/2018/03_2018_Summer/iteration2/RNAseq_analysis/res.SOL_GA_M_20180918.txt", 
            sep = "\t")
